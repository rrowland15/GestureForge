# GestureForge
Webapp allowing users to train custom static gesture recognition models and use them to control various browser actions. Application can be expanded in the future for audio recognition. Application based on previous ML model findings that can be found [here](https://github.com/rrowland15/GestureForge/blob/main/Term_Project_102%20(1).pdf). 
